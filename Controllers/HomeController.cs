...
using static part1_poe.Models.lecturers;
...
namespace part1_poe.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult lectures()
        {
            ...
            List<UserModel> allLecturers = lec.all_workers();
        ...
        {
            lecturers lec = new lecturers();
            UserModel lecturer = lec.get_worker(id);
        ...
        [HttpPost]
        public IActionResult UpdateLecturer(UserModel model)
        {
            lecturers lec = new lecturers();
            lec.update_worker(model);
        ...
        public IActionResult ApproveClaim(int id)
        {
            ...
            // Call the class method
            bool done = query.PreApproveClaims(id);
        ...
        public IActionResult ReapprovejectClaim(int id)
        {
            // Instantiate the class inside the method
            user_query query = new user_query();
